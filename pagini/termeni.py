...
# Afișare text în funcție de limbă
if st.session_state["limba"] == "RO":
    ...
    * **PLAFON REZIDUAL DE SIGURANȚĂ:** Dacă o instanță competentă anulează plafonul de £0 din cauza prezenței reclamelor, răspunderea maximă absolută a administratorului este limitată la o sumă fixă de **£10 GBP**, sumă recunoscută de utilizator ca fiind echitabilă.
