...
def run_politica():
    ...
    if st.session_state["limba"] == "RO":
        ...
        * **Controlul utilizatorului:** Puteți reseta, bloca sau gestiona acești identificatori din setările browserului dumneavoastră sau prin bannerul de consimțământ.
        ...
        Platforma folosește servicii externe precum Linktree pentru gestionarea donațiilor voluntare. Interacțiunea cu aceste link-uri se supune politicilor de confidențialitate ale platformelor respective (Linktree, PayPal, Stripe), administratorul ne fiind responsabil de datele introduse de dumneavoastră pe acele site-uri.
