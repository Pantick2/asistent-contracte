...
t = {
    ...
    "EN": {
        ...
        "prompt": "You are a legal expert specializing in freelancer protection. Analyze the provided contract text and identify major risks. Respond STRICTLY in ENGLISH. Return the result in Markdown format with the structure exact structure: Risk Name, Original Clause, Translation, Why it is dangerous, Renegotiation suggestion.",
...
# =====================================================================
# CODUL APLICAȚIEI (Rulează doar după bife)
# =====================================================================
